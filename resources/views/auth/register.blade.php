        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card" style="background-color: #1a202c">
                    <div class="card-header" style="text-align: center;color: white;font-size: 25px">{{ __('Register') }}</div>
                    ...
                    <div class="card-body" style="color: white">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="Birthday" class="col-md-4 col-form-label text-md-right">{{ __('D.O.B') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="contact_num" class="col-md-4 col-form-label text-md-right">{{ __('Phone Number') }}</label>

                                <div class="col-md-6">
                                    <input id="contact_num" type="text" class="form-control @error('contact_num') is-invalid @enderror" name="contact_num" value="{{ old('name') }}" required autocomplete="contact_num" autofocus>
